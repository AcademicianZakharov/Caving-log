    ...
    <div class="update-container">
        ...
        <form action="TripCrudServlet" method="post">
            <div>
                ...
                <input type="text" id="cave name" name="cave_name" class="input-field" value="<%=request.getParameter("saved_cave_name") %>" pattern="^[A-Za-z\s]{1,100}$" required>
            </div>
            <div>
            ...
            <div>
                ...
                <input type="tel" id="group_size" name="group_size" class="input-field" value="<%=request.getParameter("saved_group_size") %>" pattern="^\d+$" required>
            </div>
            <div>
                <label for="max_trip_length">Max Trip Length:</label>
                <input type="tel" id="max_trip_length" name="max_trip_length" class="input-field" value="<%=request.getParameter("saved_max_trip_length") %>" pattern="^\d*[\.]?[\d]*$" required>
            </div>
