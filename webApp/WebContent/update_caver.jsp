    ...
    <div class="update-container">
        ...
        <form action="CrudServlet" method="post">
            <div>
                ...
                <input type="text" id="name" name="name" class="input-field" value="<%=request.getParameter("previous_name") %>" pattern="^[A-Za-z\s]{1,100}$" required>
            </div>
            <div>
                <label for="status">Status:</label>
                <input type="text" id="status" name="status" class="input-field" value="<%=request.getParameter("previous_status") %>" pattern="^[A-Za-z\s]{1,100}$" required>
            </div>
            <div>
