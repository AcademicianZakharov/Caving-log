	...
	<div class="registration-container">
		...
		<form action="TripCrudServlet" method="post">
			...
			<div>
				...
				<input type="text" id="start_time" name="start_time" class="input-field" pattern="^\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2}$" required>

			</div>
			<div>
				<label for="end_time">End Time:</label> 
				<input type="text" id="end_time" name="end_time" class="input-field" pattern="^\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2}$" required>
			</div>
			<div>
				<label for="group_size">Group Size:</label> 
				<input type="tel" id="group_size" name="group_size" class="input-field" pattern="^\d+$" required>
			</div>
			<div>
				<label for="max_trip_length">Max Trip Length:</label> 
				<input type="tel" id="max_trip_length" name="max_trip_length" class="input-field" pattern="^\d*[\.]?[\d]*$" required>
			</div>
